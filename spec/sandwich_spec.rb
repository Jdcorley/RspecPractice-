...
# let binds a name (sandwich) to the result of 
# of the code blocks computation 
# like the memoized helper method, RSpec 
# will run the block the first time any 
# example calls sandwich.
	it 'is delicious' do
